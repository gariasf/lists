...
export const LIST_DEFINITIONS: ListDefinition[] = [
  ...
  { slug: 'easing-curves', name: 'Easing Curves', category: 'design', local: { file: 'easing-curves.txt', format: 'txt' } },
  { slug: 'radius-tokens', name: 'Radius Tokens', category: 'design', local: { file: 'radius-tokens.txt', format: 'txt' } },
  { slug: 'spacing-tokens', name: 'Spacing Tokens', category: 'design', local: { file: 'spacing-tokens.txt', format: 'txt' } },
  { slug: 'lucide-icons', name: 'Lucide Icons', category: 'design', local: { file: 'lucide-icons.txt', format: 'txt' } },
  { slug: 'design-systems', name: 'Design Systems', category: 'design', local: { file: 'design-systems.txt', format: 'txt' } },
  { slug: 'ui-components', name: 'UI Components', category: 'design', local: { file: 'ui-components.txt', format: 'txt' } },

  // Numbers (local additions)
  { slug: 'otp-codes', name: 'OTP Codes', category: 'numbers', local: { file: 'otp-codes.txt', format: 'txt' } },
  { slug: 'license-plates-us', name: 'License Plates (US)', category: 'numbers', local: { file: 'license-plates-us.txt', format: 'txt' } },
  { slug: 'license-plates-eu', name: 'License Plates (EU)', category: 'numbers', local: { file: 'license-plates-eu.txt', format: 'txt' } },
  { slug: 'license-plates-jp', name: 'License Plates (JP)', category: 'numbers', local: { file: 'license-plates-jp.txt', format: 'txt' } },
  { slug: 'phone-pins', name: 'Phone PINs', category: 'numbers', local: { file: 'phone-pins.txt', format: 'txt' } },
  { slug: 'hex-numbers', name: 'Hex Numbers', category: 'numbers', local: { file: 'hex-numbers.txt', format: 'txt' } },
  { slug: 'binary-numbers', name: 'Binary Numbers', category: 'numbers', local: { file: 'binary-numbers.txt', format: 'txt' } },
  { slug: 'octal-numbers', name: 'Octal Numbers', category: 'numbers', local: { file: 'octal-numbers.txt', format: 'txt' } },
  { slug: 'roman-numerals', name: 'Roman Numerals', category: 'numbers', local: { file: 'roman-numerals.txt', format: 'txt' } },
  { slug: 'scientific-notation', name: 'Scientific Notation', category: 'numbers', local: { file: 'scientific-notation.txt', format: 'txt' } },
  { slug: 'large-numbers', name: 'Large Numbers', category: 'numbers', local: { file: 'large-numbers.txt', format: 'txt' } },

  // Time (local additions)
  { slug: 'relative-timestamps', name: 'Relative Timestamps', category: 'time', local: { file: 'relative-timestamps.txt', format: 'txt' } },
  { slug: 'iso-timestamps-modern', name: 'ISO Timestamps (modern)', category: 'time', local: { file: 'iso-timestamps-modern.txt', format: 'txt' } },
  { slug: 'quarters', name: 'Quarters', category: 'time', local: { file: 'quarters.txt', format: 'txt' } },
  { slug: 'cron-expressions', name: 'Cron Expressions', category: 'time', local: { file: 'cron-expressions.txt', format: 'txt' } },
  { slug: 'holidays-us', name: 'Holidays (US)', category: 'time', local: { file: 'holidays-us.txt', format: 'txt' } },
  { slug: 'holidays-uk', name: 'Holidays (UK)', category: 'time', local: { file: 'holidays-uk.txt', format: 'txt' } },
  { slug: 'holidays-jp', name: 'Holidays (JP)', category: 'time', local: { file: 'holidays-jp.txt', format: 'txt' } },
  { slug: 'holidays-in', name: 'Holidays (IN)', category: 'time', local: { file: 'holidays-in.txt', format: 'txt' } },
  { slug: 'fiscal-years', name: 'Fiscal Years', category: 'time', local: { file: 'fiscal-years.txt', format: 'txt' } },
  { slug: 'sprint-dates', name: 'Sprint Dates', category: 'time', local: { file: 'sprint-dates.txt', format: 'txt' } },
  { slug: 'meeting-durations', name: 'Meeting Durations', category: 'time', local: { file: 'meeting-durations.txt', format: 'txt' } },

  // Text (local additions)
  { slug: 'tweets', name: 'Tweets', category: 'text', local: { file: 'tweets.txt', format: 'txt' } },
  { slug: 'hn-titles', name: 'HN Titles', category: 'text', local: { file: 'hn-titles.txt', format: 'txt' } },
  { slug: 'linkedin-updates', name: 'LinkedIn Updates', category: 'text', local: { file: 'linkedin-updates.txt', format: 'txt' } },
  { slug: 'reviews-5star', name: 'Reviews (5★)', category: 'text', local: { file: 'reviews-5star.txt', format: 'txt' } },
  { slug: 'reviews-1star', name: 'Reviews (1★)', category: 'text', local: { file: 'reviews-1star.txt', format: 'txt' } },
  { slug: 'slogans', name: 'Slogans', category: 'text', local: { file: 'slogans.txt', format: 'txt' } },
  { slug: 'quotes-design', name: 'Quotes (design)', category: 'text', local: { file: 'quotes-design.txt', format: 'txt' } },
  { slug: 'quotes-tech', name: 'Quotes (tech)', category: 'text', local: { file: 'quotes-tech.txt', format: 'txt' } },
  { slug: 'commit-messages-real', name: 'Commit Messages', category: 'text', local: { file: 'commit-messages-real.txt', format: 'txt' } },
  { slug: 'pr-titles', name: 'PR Titles', category: 'text', local: { file: 'pr-titles.txt', format: 'txt' } },
  { slug: 'bug-report-titles', name: 'Bug Report Titles', category: 'text', local: { file: 'bug-report-titles.txt', format: 'txt' } },
  { slug: 'customer-testimonials', name: 'Customer Testimonials', category: 'text', local: { file: 'customer-testimonials.txt', format: 'txt' } },
  { slug: 'faq-questions', name: 'FAQ Questions', category: 'text', local: { file: 'faq-questions.txt', format: 'txt' } },
  { slug: 'lorem-bacon', name: 'Bacon Ipsum', category: 'text', local: { file: 'lorem-bacon.txt', format: 'txt' } },
  { slug: 'lorem-corporate', name: 'Corporate Ipsum', category: 'text', local: { file: 'lorem-corporate.txt', format: 'txt' } },
  { slug: 'lorem-hipster', name: 'Hipster Ipsum', category: 'text', local: { file: 'lorem-hipster.txt', format: 'txt' } },

  // Education (local additions)
  { slug: 'universities-global', name: 'Universities (global)', category: 'education', local: { file: 'universities-global.txt', format: 'txt' } },
  { slug: 'college-majors', name: 'College Majors', category: 'education', local: { file: 'college-majors.txt', format: 'txt' } },
  { slug: 'degrees', name: 'Degrees', category: 'education', local: { file: 'degrees.txt', format: 'txt' } },
  { slug: 'bootcamps', name: 'Bootcamps', category: 'education', local: { file: 'bootcamps.txt', format: 'txt' } },
  { slug: 'courses-online', name: 'Online Courses', category: 'education', local: { file: 'courses-online.txt', format: 'txt' } },
  { slug: 'subjects', name: 'Subjects', category: 'education', local: { file: 'subjects.txt', format: 'txt' } },
  { slug: 'academic-titles', name: 'Academic Titles', category: 'education', local: { file: 'academic-titles.txt', format: 'txt' } },

  // Transport (local additions)
  { slug: 'ev-models', name: 'EV Models', category: 'transport', local: { file: 'ev-models.txt', format: 'txt' } },
  { slug: 'motorcycle-brands', name: 'Motorcycle Brands', category: 'transport', local: { file: 'motorcycle-brands.txt', format: 'txt' } },
  { slug: 'airline-codes', name: 'Airline Codes', category: 'transport', local: { file: 'airline-codes.txt', format: 'txt' } },
  { slug: 'transit-lines-nyc', name: 'Transit Lines (NYC)', category: 'transport', local: { file: 'transit-lines-nyc.txt', format: 'txt' } },
  { slug: 'transit-lines-london', name: 'Transit Lines (London)', category: 'transport', local: { file: 'transit-lines-london.txt', format: 'txt' } },
  { slug: 'transit-lines-tokyo', name: 'Transit Lines (Tokyo)', category: 'transport', local: { file: 'transit-lines-tokyo.txt', format: 'txt' } },
  { slug: 'bike-brands', name: 'Bike Brands', category: 'transport', local: { file: 'bike-brands.txt', format: 'txt' } },
  { slug: 'flight-numbers', name: 'Flight Numbers', category: 'transport', local: { file: 'flight-numbers.txt', format: 'txt' } },
  { slug: 'flight-routes', name: 'Flight Routes', category: 'transport', local: { file: 'flight-routes.txt', format: 'txt' } },
  { slug: 'cruise-ships', name: 'Cruise Ships', category: 'transport', local: { file: 'cruise-ships.txt', format: 'txt' } },

  // Health (local additions)
  { slug: 'medical-conditions', name: 'Medical Conditions', category: 'health', local: { file: 'medical-conditions.txt', format: 'txt' } },
  { slug: 'medications-generic', name: 'Medications (generic)', category: 'health', local: { file: 'medications-generic.txt', format: 'txt' } },
  { slug: 'body-parts', name: 'Body Parts', category: 'health', local: { file: 'body-parts.txt', format: 'txt' } },
  { slug: 'vitamins', name: 'Vitamins & Supplements', category: 'health', local: { file: 'vitamins.txt', format: 'txt' } },
  { slug: 'diets', name: 'Diets', category: 'health', local: { file: 'diets.txt', format: 'txt' } },
  { slug: 'yoga-poses', name: 'Yoga Poses', category: 'health', local: { file: 'yoga-poses.txt', format: 'txt' } },
  { slug: 'exercises-strength', name: 'Exercises (strength)', category: 'health', local: { file: 'exercises-strength.txt', format: 'txt' } },
  { slug: 'exercises-cardio', name: 'Exercises (cardio)', category: 'health', local: { file: 'exercises-cardio.txt', format: 'txt' } },
  { slug: 'fitness-apps', name: 'Fitness Apps', category: 'health', local: { file: 'fitness-apps.txt', format: 'txt' } },
  { slug: 'hospitals', name: 'Hospitals', category: 'health', local: { file: 'hospitals.txt', format: 'txt' } },

  // Nature (local additions)
  { slug: 'pets-dog-names', name: 'Dog Names', category: 'nature', local: { file: 'pets-dog-names.txt', format: 'txt' } },
  { slug: 'pets-cat-names', name: 'Cat Names', category: 'nature', local: { file: 'pets-cat-names.txt', format: 'txt' } },
  { slug: 'plants-indoor', name: 'Indoor Plants', category: 'nature', local: { file: 'plants-indoor.txt', format: 'txt' } },
  { slug: 'succulents', name: 'Succulents', category: 'nature', local: { file: 'succulents.txt', format: 'txt' } },
  { slug: 'trees', name: 'Trees', category: 'nature', local: { file: 'trees.txt', format: 'txt' } },
  { slug: 'flowers', name: 'Flowers', category: 'nature', local: { file: 'flowers.txt', format: 'txt' } },
  { slug: 'herbs', name: 'Herbs', category: 'nature', local: { file: 'herbs.txt', format: 'txt' } },
  { slug: 'weather-conditions', name: 'Weather Conditions', category: 'nature', local: { file: 'weather-conditions.txt', format: 'txt' } },
  { slug: 'gemstones', name: 'Gemstones', category: 'nature', local: { file: 'gemstones.txt', format: 'txt' } },
  { slug: 'minerals', name: 'Minerals', category: 'nature', local: { file: 'minerals.txt', format: 'txt' } },
  { slug: 'dog-breeds', name: 'Dog Breeds', category: 'nature', local: { file: 'dog-breeds.txt', format: 'txt' } },
  { slug: 'cat-breeds', name: 'Cat Breeds', category: 'nature', local: { file: 'cat-breeds.txt', format: 'txt' } },

  // Culture (local additions)
  { slug: 'mythology-greek', name: 'Mythology (Greek)', category: 'culture', local: { file: 'mythology-greek.txt', format: 'txt' } },
  { slug: 'mythology-norse', name: 'Mythology (Norse)', category: 'culture', local: { file: 'mythology-norse.txt', format: 'txt' } },
  { slug: 'mythology-egyptian', name: 'Mythology (Egyptian)', category: 'culture', local: { file: 'mythology-egyptian.txt', format: 'txt' } },
  { slug: 'mythology-hindu', name: 'Mythology (Hindu)', category: 'culture', local: { file: 'mythology-hindu.txt', format: 'txt' } },
  { slug: 'fantasy-elf-names', name: 'Fantasy Elf Names', category: 'culture', local: { file: 'fantasy-elf-names.txt', format: 'txt' } },
  { slug: 'fantasy-dwarf-names', name: 'Fantasy Dwarf Names', category: 'culture', local: { file: 'fantasy-dwarf-names.txt', format: 'txt' } },
  { slug: 'fantasy-orc-names', name: 'Fantasy Orc Names', category: 'culture', local: { file: 'fantasy-orc-names.txt', format: 'txt' } },
  { slug: 'scifi-ship-names', name: 'Sci-Fi Ship Names', category: 'culture', local: { file: 'scifi-ship-names.txt', format: 'txt' } },
